...
import service.newMatch.GameRegularPlayerPoints;
import service.newMatch.GameRegularScore;
import service.newMatch.State;

import static org.assertj.core.api.Assertions.assertThat;

public class GameRegularScoreTest {
    ...
    public void TestAdvantage() {
        ...
        assertThat(score.pointWon(0)).isEqualTo(State.ONGOING);
        assertThat(score.getPlayerScores(0)).isEqualTo(GameRegularPlayerPoints.ADVANTAGE);

        // FORTY- FORTY again if second player won points
        assertThat(score.pointWon(1)).isEqualTo(State.ONGOING);
        assertThat(score.getPlayerScores(0)).isEqualTo(GameRegularPlayerPoints.FORTY);
        assertThat(score.getPlayerScores(1)).isEqualTo(GameRegularPlayerPoints.FORTY);
